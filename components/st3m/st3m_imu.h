...
extern void st3m_imu_task_acc_gyro(void);
extern void st3m_imu_task_temperature(void);
extern void st3m_imu_task_steps(void);
...
extern void st3m_imu_reset_steps(void);
