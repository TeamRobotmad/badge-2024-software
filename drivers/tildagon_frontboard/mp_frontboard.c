...
static const mp_rom_map_elem_t frontboard2026_globals_table[] =
{
    ...
    { MP_ROM_QSTR(MP_QSTR_TOUCH03), MP_ROM_INT(MP_TOUCH_EVENT_10) },
    { MP_ROM_QSTR(MP_QSTR_TOUCH04), MP_ROM_INT(MP_TOUCH_EVENT_9) },
    { MP_ROM_QSTR(MP_QSTR_TOUCH05), MP_ROM_INT(MP_TOUCH_EVENT_8) },
    { MP_ROM_QSTR(MP_QSTR_TOUCH06), MP_ROM_INT(MP_TOUCH_EVENT_7) },
    { MP_ROM_QSTR(MP_QSTR_TOUCH07), MP_ROM_INT(MP_TOUCH_EVENT_6) },
    { MP_ROM_QSTR(MP_QSTR_TOUCH08), MP_ROM_INT(MP_TOUCH_EVENT_5) },
    { MP_ROM_QSTR(MP_QSTR_TOUCH09), MP_ROM_INT(MP_TOUCH_EVENT_4) },
